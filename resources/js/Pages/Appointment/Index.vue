        ...
        <div class="px-2 mt-5">
            <div class="p-4 mx-2">
                <div class="flex ">
                    ...
                    <Link href="/appointment/create" class="bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded mb-2 mr-4" >Create Appointment</Link>
                </div>
                ...
                <div class="h-12">
                    <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                        ...
                        <table class="min-w-max w-full table-auto" >
                            ...
                            <tbody class="text-gray-600 text-sm font-light" v-for="app in appointments" :key="app.id" >

                                <tr  class="border-b border-gray-200 hover:bg-gray-100">
                                    <td class="py-3 px-6 text-left whitespace-nowrap">
                                        <div class="flex items-center">

                                            <p class="font-medium">{{ app.id }}</p>
                                        </div>
                                    </td>
                                        ...
                                        <div class="flex items-center justify-center">
                                            <p class="font-medium">
                                                ...
                                                :class="{
                                                    ...
                                                    'bg-red-200 text-red-600':app.status == 'Canceled',
                                    ...
                                    <td class="py-3 px-6 text-center">
                                        <div class="flex item-center justify-center">
                                            ...
                                            <div class="w-4  ml-2 mr-2 transform hover:text-red-500 hover:scale-110">
                                                <a href="#" @click="remove(app)" class="btn" title="Delete Category">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
