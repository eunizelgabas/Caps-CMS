...
<template>
    ...
    <Sidebar>
        ...
        <template #header>
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">Create Patients</h2>
        </template>
            ...
            <form @submit.prevent="submit">
                <div class="space-y-6">
                    <div class="block pl-12 font-semibold text-xl self-start text-gray-700">
                        <h1 class="leading-relaxed">Patient Details Form</h1>
                        <hr>
                      </div>
                  <div class="border-b border-gray-900/10 pb-12">
                    ...
                    <div class=" px-12 py-2 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-3 mx-auto">
                        ...
                        <div class="sm:col-span-1">
                            ...
                            <div class="mt-2">
                            <input id="contact_no" v-model="form.contact_no" name="contact_no" type="text" autocomplete="contact_no" class="block w-full rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
